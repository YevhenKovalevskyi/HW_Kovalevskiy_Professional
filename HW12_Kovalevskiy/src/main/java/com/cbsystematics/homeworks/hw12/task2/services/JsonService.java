package com.cbsystematics.homeworks.hw12.task2.services;
...
public class JsonService {
    ...
    public static String setDataToJson(String jsonData, String filePath) throws IOException {
        ...
        try {
            ...
            mapper.writeValue(path.toFile(), mapper.readTree(jsonData.replace("'", "\"")));
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        
        return "Json data successfully saved using Jackson!";
    }
}
