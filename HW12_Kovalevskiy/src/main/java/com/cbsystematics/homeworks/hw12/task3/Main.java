package com.cbsystematics.homeworks.hw12.task3;

import com.cbsystematics.homeworks.hw12.task3.helpers.FilesHelper;
import com.cbsystematics.homeworks.hw12.task3.services.JsonService;

import java.io.IOException;

/**
 * Main Class represents homework #12 #task3
 *
...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String filePath = FilesHelper.getResourceRootFilePath(Main.class, "Main.class", "task3.json");
